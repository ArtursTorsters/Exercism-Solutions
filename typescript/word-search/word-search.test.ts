...
describe('single line grids', () => {
  ...
  test('should accept a target search word', () => {
    const grid = ['jefblpepre']
    const wordSearch = new WordSearch(grid)
...
describe('multi line grids', () => {
  test('should locate a left to right word in a two line grid', () => {
  ...
  test('should locate a left to right word in a different position in a two line grid', () => {
  ...
  test('should locate a left to right word in a three line grid', () => {
  ...
  test('should locate a left to right word in a ten line grid', () => {
    const grid = [
      'jefblpepre',
      'camdcimgtc',
      'oivokprjsm',
  ...
  test('should locate a left to right word in a different position in a ten line grid', () => {
    const grid = [
      'jefblpepre',
      'camdcimgtc',
      'oivokprjsm',
...
describe('multiple words', () => {
  test('should locate two words written left to right', () => {
    const grid = [
      'aefblpepre',
      'camdcimgtc',
      'oivokprjsm',
